...
function renderPokemon(pokemon) {
  ...
  var imgPika = document.createElement('img');
  var url = pokemon.imageUrl;
  imgPika.setAttribute('src', url);
  pokemonCard.appendChild(imgPika);
...
for (var i = 0; i < pokedex.length; i++) {
  var DOMpokemon = renderPokemon(pokedex[i]);
  rowElement.appendChild(DOMpokemon);
}
